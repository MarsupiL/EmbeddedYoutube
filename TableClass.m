...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    tbc = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if(tbc == nil)
    {
        tbc = [[tableCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
    //youtube video
    ...
    [tbc.webV loadHTMLString:htmlString baseURL:[NSURL URLWithString:@"http://www.youtube.com"]];
